...
public class PartThreeIntegrationTests {
    ...
    @OOPTestClass(value = OOPTestClass.OOPTestClassType.ORDERED)
    public static class SixthIntTest extends FourthIntTest{
    ...
    @OOPTestClass(value = OOPTestClass.OOPTestClassType.ORDERED)
    public static class EighthIntTest extends SeventhIntTest{
    ...
    public static class TenthIntTest{
        ...
        @OOPBefore(value = {"first_test"})
        public void failing_before() throws IOException {
    ...
    public static class EleventhIntTest{
        ...
        @OOPAfter(value = {"first_test"})
        public void failing_after() throws IOException {
            test_string = "Goodbye";
            after_crashed = 1;
    ...
    @OOPTestClass
    public static class TwelthIntTest{
    ...
    @OOPTestClass
    public static class ThirteenthIntTest extends TwelthIntTest{
    ...
    public static class FourteenthIntClass {
        ...
        public void failing_before() throws Exception {
            if(counter == 1){
                counter --;
        ...
        public void failing_after() throws Exception {
            if(counter == 0){
                counter ++;
                throw new Exception("trash Exception");
            } else{}
    ...
    @Test
    public void testBackingUpPrivateBefore() throws NoSuchFieldException, IllegalAccessException {
        OOPUnitCore.runClass(TenthIntTest.class);
    ...
    @Test
    public void testBackingUpPrivateAfter() throws NoSuchFieldException, IllegalAccessException {
        OOPUnitCore.runClass(EleventhIntTest.class);
    ...
    @Test
    public void testObjectBackUpCloningOOPBeforeCrash() throws NoSuchFieldException, IllegalAccessException {
    ...
    @Test
    public void testObjectBackUpCloningOOPAfterCrash() throws NoSuchFieldException, IllegalAccessException {
    ...
    @Test
    public void testObjectBackUpCopyConstructorOOPBeforeCrash() throws NoSuchFieldException, IllegalAccessException {
    ...
    @Test
    public void testObjectBackUpCopyConstructorOOPAfterCrash() throws NoSuchFieldException, IllegalAccessException {
    ...
    public void testRunningTestsByOrderOfInheritance(){
        ...
        assertEquals(111111,TwelthIntTest.orderTest);
    }
